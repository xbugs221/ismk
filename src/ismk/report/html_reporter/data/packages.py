...
from ismk.assets import AssetDownloadError, Assets
...
def get_packages():
    ...
    # packages declared here must be downloaded to the prefix share/ismk/assets
    # via setuptools_download in setup.cfg
    return Packages(
        {
            "ismk": Package(
                version=ismk.__version__.split("+")[0],
                license_path="ismk/LICENSE.md",
            ),
            "pygments": Package(
