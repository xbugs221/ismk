...
from ismk.report.common import data_uri_from_file
from ismk.report.html_reporter import data

from ismk.report.rulegraph_spec import rulegraph_spec
from ismk.report.html_reporter.common import get_resource_as_string, get_result_uri
...
class Reporter(ReporterBase):
    def __post_init__(self):
        ...
        self.env = Environment(
            loader=PackageLoader("ismk", "report/html_reporter/template"),
            trim_blocks=True,
            lstrip_blocks=True,
        )
