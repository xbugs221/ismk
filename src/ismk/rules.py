...
from ismk.resources import infer_resources
from ismk.interfaces.common.utils import not_iterable, lazy_property
...
class Rule(RuleInterface):
    ...
    def expand_params(self, wildcards, input, output, job, omit_callable=False):
        ...
        try:
            ...
            raise WildcardError(
                ...
                "see https://ismk.readthedocs.io/en/stable/snakefiles/"
    ...
    def expand_conda_env(self, wildcards, params=None, input=None):
        ...
        from ismk.common import is_local_file
        from ismk.sourcecache import SourceFile, infer_source_file
        from ismk.deployment.conda import (
            CondaEnvFileSpec,
            CondaEnvNameSpec,
            CondaEnvDirSpec,
            CondaEnvSpecType,
