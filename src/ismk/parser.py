...
from ismk import common

if TYPE_CHECKING:
    from ismk import sourcecache, workflow
...
class TokenAutomaton:
    ...
    def error(self, msg, token, naming_hint=None):
        if naming_hint is not None:
            msg += (
                f" The keyword {naming_hint} has a special meaning in SMK. "
...
class KeywordState(TokenAutomaton):
    ...
    def end(self):
        # Add newline to prevent https://github.com/ismk/ismk/issues/1943
        yield "\n"
        yield ")"
