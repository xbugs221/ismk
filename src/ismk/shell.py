...
from ismk.utils import format, argvquote, cmd_exe_quote
from ismk.common import ON_WINDOWS, RULEFUNC_CONTEXT_MARKER
...
class shell:
    ...
    def __new__(
        ...
        # if the rule requires a Python module, ismk's environment might be
        ...
        if len(cmd.replace("'", r"'\''")) + 2 > MAX_ARG_LEN:
            tmpdir = tempfile.mkdtemp(dir=".ismk", prefix="shell_tmp.")
        ...
        if bench_record is not None:
            from ismk.benchmark import benchmarked
