...
from ismk.common import get_container_image
...
def job_to_cwl(job, dag, outputs, inputs):
    ...
    def get_output_id(job, i):
        return f"#main/job-{job.jobid}/{i}"
    ...
    [get_output_id(job, i) for i, _ in enumerate(job.output)]
