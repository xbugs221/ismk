...
from ismk.common.prefix_lookup import PrefixLookup
from ismk.exceptions import WorkflowError
from ismk.io import is_callable, is_flagged, AnnotatedString, flag, get_flag_value
...
class PathModifier:
    ...
    def apply_default_storage(self, path):
        ...
        """
        from ismk.storage import flag_with_storage_object
