...
from ismk.exceptions import CreateCondaEnvironmentException, WorkflowError
...
from ismk.deployment import singularity, containerize
from ismk.io import (
    IOFile,
    apply_wildcards,
    contains_wildcard,
...
class Env:
    ...
    def pin_file(self):
        return self._get_aux_file(
            ...
            "(https://ismk.readthedocs.io/en/stable/snakefiles/"
            ...
            try:
                ...
                if os.path.exists(env_archive):
                    ...
                    def create_env(env_file, filetype="yaml"):
                        ...
                        # environment in .ismk/conda contains.
    ...
    def _check_version(self):
        ...
        if Version(version) < Version(MIN_CONDA_VER):
            raise CreateCondaEnvironmentException(
                ...
                "Note that you can also install conda into the ismk environment "
