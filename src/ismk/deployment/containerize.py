...
from ismk.io import is_callable, contains_wildcard
...
def containerize(workflow, dag):
    ...
    print('LABEL io.github.ismk.containerized="true"')
    print(f'LABEL io.github.ismk.conda_env_hash="{envhash.hexdigest()}"')
