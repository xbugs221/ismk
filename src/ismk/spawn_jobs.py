...
from ismk.interfaces.executor_plugins.utils import format_cli_arg, join_cli_args
from ismk.interfaces.executor_plugins.settings import CommonSettings
from ismk.resources import ParsedResource
from ismk.interfaces.storage_plugins.registry import StoragePluginRegistry

from ismk import PIP_DEPLOYMENTS_PATH
...
class SpawnedJobArgsFactory:
    ...
    def precommand(
        ...
        if (
            ...
            precommand.append(
                f"{python_executable} -m ismk --deploy-sources "
