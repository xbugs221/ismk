...
from ismk.common import Rules

from ismk.exceptions import CreateRuleException, WorkflowError
from ismk.io.flags import DefaultFlags
from ismk.path_modifier import PathModifier
...
class ModuleInfo:
    ...
    def get_snakefile(self):
        if self.meta_wrapper:
            for snakefile in ("/meta_wrapper.ismk", "/test/Snakefile"):
            ...
            raise WorkflowError(
                ...
                "meta_wrapper.ismk or test/Snakefile (old style)."
            )
        elif self.snakefile:
